...
const Footer = () => {
    return (
        <footer class="text-gray-600 body-font mt-[10%] max-[700px]:mt-[35%]  lg:block bg:white">
            <div class=" px-5 py-8 mx-auto flex items-center justify-between flex-row ">
                {/* <span class=" title-font font-medium   text-gray-900"> */}
                    <Image
                        src={fav}
                        className=" cursor-pointer max-[700px]:w-[6%] max-[700px]:h-[4%]  max-[400px]:w-[10%] max-[400px]:h-[8%] h-[2%] w-[4%]"
                        // width={5000}
                        // height={5000}
                        alt="p"
                    ...
                    />
                {/* </span> */}
                <p class="text-[70%] text-gray-600 ml-4 pl-4 border-l-2 border-gray-400 py-2 sm:mt-0 mt-4 items-end">© 2023 Yudiz Forms
                </p>
